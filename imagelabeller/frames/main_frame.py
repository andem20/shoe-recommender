...
class MainFrame(tk.Frame):
    def __init__(self, parent: tk.Frame, controller: tk.Tk, store: DataStore = None):
        ...
        self.index_label.grid(row = 2, column = 2, padx = 10, pady = 10)
        ...
        self.image_label.grid(row = 1, column = 3, padx = 10, pady = 10)

        # Buttons
        self.open_dir_button = tk.Button(self, text ="Open directory", command = self._open_dir)
        self.open_dir_button.grid(row = 0, column = 2, padx = 10, pady = 10)
